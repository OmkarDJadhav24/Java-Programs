// Write java program to accept directory name from user and write data of all files along with file name and size into newly created file named as marvellous.txt.
...
class WriteFiles
{
	...
	for (File filename : files) 
	{
	       ...
	       String data = myReader.nextLine();
               ...
               pw.println(data); 
               pw.println(filename);
               pw.println(filename.length()+" Bytes");
               pw.flush();
