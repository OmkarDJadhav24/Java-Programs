// Write a java program which accept two arrays and display odd contents of each array.
...
class MyArray
{
    ...
    public void DisplayOdd()
    {
        ...
        System.out.println("Odd elements of Arr:");
        for(i=0;i<Arr.length;i++)
        {
            if((Arr[i]%2)!=0)
            {
        ...
        System.out.println("Odd elements of Brr:");
        for(i=0;i<Brr.length;i++)
        {
            if((Brr[i]%2)!=0)
            {
